"""
Django settings for CleaningService project.
...
SECRET_KEY = 'django-insecure-a(tg(npt@*ix%uardv14q+6!y7_*_l44s$*imnw)vehf(qxk0d'
...
ROOT_URLCONF = 'CleaningService.urls'
...
WSGI_APPLICATION = 'CleaningService.wsgi.application'
